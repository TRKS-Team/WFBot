...
dotnet publish WFBot -o out/WFBotLinuxArm64S -r linux-arm64 --self-contained true -c "Linux Release" -p:PublishSingleFile=true -p:PublishReadyToRun=true /p:IncludeNativeLibrariesForSelfExtract=true
dotnet publish WFBot -o out/WFBotLinuxX64S -r linux-x64 --self-contained true -c "Linux Release" -p:PublishSingleFile=true -p:PublishReadyToRun=true /p:IncludeNativeLibrariesForSelfExtract=true
