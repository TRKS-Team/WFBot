...
2. 前往 <https://github.com/iTXTech/mcl-installer> 查看安装或自行构建.
...
8. 启动 mirai. 使用 `login [账号] [密码]` 登录或者 `autologin add [账号] [密码]` 配置自动登录 QQ.
